...
OUTPUT_FOLDER = '../front/public/output'
...
def split_audio(filename, stem):
    ...
    if stem == 2:
        ...
        output_files = {"voice" : song_folder + '/vocals.wav', "bass" : song_folder + '/bass.mp3', "drums": song_folder + '/drums.wav', "other": song_folder + '/other.wav'}
    elif stem == 5:
        output_files = {"voice" : song_folder + '/vocals.wav', "bass" : song_folder + '/bass.mp3', "drums": song_folder + '/drums.wav', "piano": song_folder + '/piano.wav', "other": song_folder + '/other.wav'}
    return output_files
